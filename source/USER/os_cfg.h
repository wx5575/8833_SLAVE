...
#define OS_TMR_CFG_MAX            5    /*     Maximum number of timers                                 */
#define OS_TMR_CFG_NAME_SIZE     16    /*     Determine the size of a timer name                       */
#define OS_TMR_CFG_WHEEL_SIZE     5    /*     Size of timer wheel (#Spokes)                            */
#define OS_TMR_CFG_TICKS_PER_SEC 100    /*     Rate at which timer management task runs (Hz)            */
#define OS_TASK_TMR_PRIO		 TIMER_TASK_PRIO   //软件定时器的优先级,设置为最高
